...
export default function PostulacionesPendientes() {
  ...
  const fetchPuestos = async () => {
    ...
    setError('');
    try {
      const response = await fetch(`${API_URL}/api/company/job/attention`, {
        method: 'GET',
        credentials: 'include',
      });
  ...
  const actualizarACVISTO = async (id_aplicacion) => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/company/job/cv`, {
        method: 'PUT',
  ...
  const actualizarFinalista = async (id_aplicacion) => {
    ...
    try {
      const response = await fetch(`${API_URL}/api/company/job/update/finalist`, {
        method: 'PUT',
        headers: {
  ...
  const actualizarProcesoFinalizado = async (id_aplicacion) => {
    setAprobandoId(id_aplicacion);
    try {
      const response = await fetch(`${API_URL}/api/company/job/update/process-finished`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
